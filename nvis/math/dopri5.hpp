...
public:
        ...
        struct step {
                ...
                step() :  _y0(0), _y1(0), _t0(0), _t1(0) {}
#else
                step() : _p{0.0}, _y0(0), _y1(0), _t0(0), _t1(0) {}
#endif
        ...
        dopri5() :
                        ...
                        n_accepted(0), n_rejected(0), n_steps(0), n_eval(0), t(0),
                        facold(1e-4), hlamb(0.0), iasti(0), nonsti(0), total_ee(0) {
        ...
        template<typename RHS> double h_init(const RHS& rhs,
                ...
                double sk=0.0, sqr=0.0;
                double dnf = 0.0;
                double dny = 0.0;

                double h = h_max; //initialize
        ...
        template<typename RHS> result do_step(const RHS& rhs,
                ...
                while (true) {
                        ...
                        double err = 0.0, h_new = 0.0, fac11 = 0.0;
                        ...
                        if (err <= 1.0) {
                                ...
                                if (!(n_accepted % nstiff) || (iasti > 0)) {
                                        double stnum = 0.0, stden = 0.0, sqr=0.0;
